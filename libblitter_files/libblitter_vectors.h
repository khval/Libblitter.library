...
extern void                 VARARGS68K _libblitter_BLTSIZH(struct LibBlitterIFace *, struct Custom * custom);
extern void                 VARARGS68K _libblitter_BLTSIZE(struct LibBlitterIFace *, struct Custom * custom);
