/* :ts=4
 *  $VER: BLTSIZH.c $Revision$ (21-Nov-2023)
 *
...
void _libblitter_BLTSIZH(struct LibBlitterIFace *Self,
       struct Custom * custom)
{
	...
	blitzenWrite( BLTSIZV, custom -> bltsize, &handled, &bstate );
	blitzenWrite( BLTSIZH, custom -> bltsize, &handled, &bstate );
